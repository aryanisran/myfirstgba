...
static inline u16		currentKeyState()           { return __currKeys; }
static inline u16		prevKeyState()              { return __prevKeys; }
static inline u16		keyDown(u16 a_key)       { return __currKeys & a_key; }
static inline u16		keyUp(u16 a_key)         { return ~__currKeys & a_key; }
static inline u16		keyHeld(u16 a_key)       { return (__currKeys & __prevKeys) & a_key; }
static inline u16		keyReleased(u16 a_key)   { return (~__currKeys & __prevKeys) & a_key; }
static inline u16		keyHit(u16 a_key)        { return (__currKeys & ~__prevKeys) & a_key; }
static inline u16		keyStateChange(u16 a_key){ return (__currKeys ^ __prevKeys) & a_key; }
...
static inline s16	getAxis(AXIS a_val)
{
	switch (a_val)
	{
	case HORIZONTAL:
